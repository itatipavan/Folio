...
const About = () => {
  const features = [
    ...
    },
    {
      icon: Globe,
      title: 'Web Solutions',
      description: 'Delivering end-to-end web solutions that drive business growth and user engagement.',
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {features.map((feature, index) => {
            ...
            return (
              ...
              >
                {/* Glow Effect */}
                <div className={`absolute -inset-0.5 bg-gradient-to-r ${feature.gradient} rounded-2xl blur opacity-30 group-hover:opacity-75 transition duration-1000`}></div>
                
                {/* Card Content */}
                <div className="relative p-8 bg-white rounded-2xl shadow-xl h-full">
                  <div className={`w-16 h-16 bg-gradient-to-br ${feature.gradient} rounded-2xl flex items-center justify-center mb-6 transform transition-transform duration-300 group-hover:scale-110 group-hover:rotate-6`}>
